...
copy %PATH_2%\lib64\windows\*.dll MidiEditor-win64\win_root\
rem Copy Encoders
...
mkdir install
copy /Y MidiEditor-win64\output\MidiEditor-%MIDI_RELEASE_F%-Setup.exe install\MidiEditor-%MIDI_RELEASE_F%-64bits-Setup.exe
