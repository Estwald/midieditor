...
set "MY_COMPILER=%MY_QT%\msys64\mingw32\bin"

rem QT lib, project, build...

set "MY_QT_LIB=%MY_QT%\6.9.0\mingw_msys32_static"
set "MY_PROJECT=..\midieditor.pro"
set "MY_BUILD=../build/build-Midieditor-32bits-static"
set PARAMS="DEFINES += __ARCH32__" "STATIC_BUILD = 1"
